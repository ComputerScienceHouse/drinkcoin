...
const uint64_t CRYPTONOTE_PUBLIC_ADDRESS_BASE58_PREFIX       = 31067;
...
const uint64_t MONEY_SUPPLY                                  = UINT64_C(16900000000000000000);
...
const char     CRYPTONOTE_NAME[]                             = "drinkcoin";
...
const int      RPC_DEFAULT_PORT                              =  42068;
...
const char* const SEED_NODES[] = { "drinkcoin01.csh.rit.edu:42069", "drinkcoin02.csh.rit.edu:42069" };
